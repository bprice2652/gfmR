...
assign are going to randomly assign fods.  
```{r}
set.seed(1010)
n=dim(Response)[1]
sampID=rep(5,n)
...
The function `GFMR.cv` is the corss validaiton function.  We have added multicore functionality for platforms that support it.  WINDOWS users should use `n.cores=1`.  The example provided here has 944
observatons with 7 response categories.  We implement 5 cores to speed up the 5 fold cross validation.
```{r}
...
the Independent republican, democrat and indepednents.